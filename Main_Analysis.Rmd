...
* Both countries Germany and South Korea are considered industry nations, thus we can assume that there is at least a small similarity in terms of life quality, infrastructure, health care system, etc. However, Korea has more than twice the number of inhabitants per km² and still had low number of infection cases. Therefore, it seems interesting to further investigate what happened in South Korea. 
