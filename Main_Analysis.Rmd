...
After joining both tables, we plot the data and calculate the correlation between both variables. We also look into cross-correlation to account for a possible time gap between search volume and daily cases. Finally we apply the Pearson correlation test to possibly reject the null-hypothesis of not correlated variables upon the commonly used significance level of alpha = 0.05.
...
To account for the different units of both variables, we use a second y-axis.
