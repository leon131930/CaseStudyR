...
* At first it doesn't seem like the Shincheonji cases were such as big deal. Compared to the overall daily cases the number of church related cases was relatively low.
...
* Also, at least in terms of the timeline the church event fits pretty well to the beginning of the first larger outbreak. 
* Let's dive a bit deeper. There has to be a reason why everyone was going nuts about this one! Are we able find the top 10 infection reasons?
...
* Alright, indeed a couple of people were tested positive in a different regions than Dague but were still identified as "Shincheonji Church related". Thus indicating, that they travelled while beinf infected with the virus. 
* Gyeongsangbuk-do has quite a large number of positive tested people that are related to the church. One could argue, that this probably is a region bordering Daegu.
* Are we able to plot this on a map showing in what region exactly the church related people were tested positive for Covid?
...
* While obviously the most cases related to the church occurred in Daegu or close to Daegu, this map shows pretty well that positive tested people that were somehow related to that church event, appeared **all over the country**.
* Thus, people traveling from Daegu to e.g. Seoul while being infected, might have cause the virus to spread. From that one outbreak in Daegu into the whole country - and maybe even further.
...
It highlights the importance of policies such as travel restrictions that are making sure that in case such an event happens, the infected people do not travel to a different location, taking the virus with them. 
However one cannot say for sure, that the church was the main reason for the severe Covid outbreak in South Korea. There are simply too many other variables that could have influenced this.
...
To sum it up, YES, the Church Event had an impact on the Covid spread in South Korea. We can confirm, that the Shincheonji Church event was one reason that ultimately led to skyrocketing cases in the country. Thus, we are able confirm our claim. 
However, we would **not** be able to confirm that the superspreader event was the number one reason or one of the main reasons for the outbreak. Thus, the picture that was communicated in the local as well as international media is not quite accurate.
<p>&nbsp;</p>
